...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
    ...
    {{-- Total Tickets --}}
    <a href="{{ route('admin.tickets.index') }}" aria-label="View all tickets" class="block">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow focus:outline-none focus:ring-2 focus:ring-purple-500">
    ...
    {{-- Total Users --}}
    <a href="{{ route('admin.users.index') }}" aria-label="View users" class="block">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow focus:outline-none focus:ring-2 focus:ring-purple-500">
            <div class="flex items-center justify-between">
                <div class="flex-1">
    ...
    {{-- Categories --}}
    <a href="{{ route('admin.categories.index') }}" aria-label="View categories" class="block">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow focus:outline-none focus:ring-2 focus:ring-purple-500">
            <div class="flex items-center justify-between">
                <div class="flex-1">
    ...
    {{-- Labels --}}
    <a href="{{ route('admin.labels.index') }}" aria-label="View labels" class="block">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow focus:outline-none focus:ring-2 focus:ring-purple-500">
            <div class="flex items-center justify-between">
                <div class="flex-1">
    ...
    {{-- Open Tickets --}}
    <a href="{{ route('admin.tickets.index', ['status' => 'Open']) }}" aria-label="View open tickets" class="block">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow focus:outline-none focus:ring-2 focus:ring-purple-500">
            <div class="flex items-center justify-between">
                <div class="flex-1">
    ...
    {{-- Resolved Tickets --}}
    <a href="{{ route('admin.tickets.index', ['status' => 'Resolved']) }}" aria-label="View resolved tickets" class="block">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow focus:outline-none focus:ring-2 focus:ring-purple-500">
            <div class="flex items-center justify-between">
                <div class="flex-1">
